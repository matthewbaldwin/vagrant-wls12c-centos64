...
node 'vagrantcentos64.example.com' {
   ...
   include os2, wls12, wls12c_domain, orautils, maintenance
   Class['os2']  -> Class['wls12'] -> Class['wls12c_domain'] -> Class['maintenance']
}
...
class wls12{
  ...
  $user            = "oracle"
  $group           = "dba"
  $downloadDir     = "/vagrant/puppet/modules/wls/files"
